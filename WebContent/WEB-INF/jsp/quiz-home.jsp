...
<div id="main" class="Form">
	...
	<!--  Manage menus -->
			...
			<form:form name="PlayForm" action="submit-play.q">
				...
				<br/>
				<div class="FieldDiv">
					<a class="SaveButton" href="bigscorecard.q">ScoreCard</a>
					<a class="SaveButton" href="buy.q">Buy Game</a>
					<c:if test="${session.username == 'admin'}">
						<a class="SaveButton" href="start-create-quiz.q">Create Quiz</a>
					</c:if>
					<a class="SaveButton" href="logout.q">Logout</a>
				</div>
			</form:form>
